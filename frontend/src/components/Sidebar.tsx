...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-dark-100 shadow-sm z-40">
      <div className="flex flex-col h-full">
        ...
        <div className="h-16 flex items-center px-6 border-b border-dark-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-dark-900">Cold Email</h1>
              <p className="text-xs text-dark-500">AI Assistant</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 py-4 border-t border-dark-100">
          <div className="px-4 py-3 rounded-lg bg-gradient-to-r from-primary-50 to-cyan-50">
            <p className="text-xs font-medium text-primary-700">Pro Tip</p>
            <p className="text-xs text-dark-600 mt-1">
              Upload a CSV to quickly add multiple contacts.
            </p>
          </div>
        </div>
      </div>
